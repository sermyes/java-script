...
// $()는 jquery 식별자
$(document).ready(function(){ // $(document).ready(function(){}) 는 document가 로딩되었을 떄(준비완료) 함수 실행
    $('#runEx8').click(welcome); // id가 runEx8인 button이 .click되었을 때, welcome함수 실행
});
...
function writeHello(){
    if(!isNaN(arguments[0])){
        document.write(arguments[0] + '.Hello ');
    }
    else{
        document.write('Hello ');
    }
}
callFunctionTenTimes(writeHello);
